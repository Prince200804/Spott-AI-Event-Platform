...
import { CalendarIcon, Loader2, Sparkles, Crown } from "lucide-react";
...
export default function CreateEventPage() {
  ...
  // Get current user with Pro status
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-5 md:flex-row justify-between mb-10">
        <div>
          <h1 className="text-4xl font-bold flex items-center gap-3">
            Create Event
            {hasPro && (
              <Badge className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-3 py-1 gap-1.5">
          ...
          {hasPro && (
            <p className="text-sm text-purple-400 mt-2">
              ✨ Unlimited events & premium features enabled
            </p>
          )}
        </div>
